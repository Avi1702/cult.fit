...
export const Navbar = () => {
  ...
  return (
    <>
    <div style={{height:"60px",backgroundColor:"#15171C",width:"100%",display:"flex",overflow:"auto",paddingTop:"15px",paddingBottom:"15px",paddingRight:"30px",paddingLeft:"30px",position:"sticky"}}>
    <img 
